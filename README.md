...
- มีมุมมองฟาร์ม Three.js แบบ 3D low-poly พร้อมปุ่มสลับกลับ 2D โดยใช้สถานะผู้เล่น ต้นไม้ สัตว์ บ้าน รั้ว ของตกแต่ง และบ่อน้ำชุดเดียวกัน คลิกพื้นเพื่อเดินและคลิกสัตว์เพื่อเปิดหน้าดูแลได้ตรงกับฉาก 3D หาก WebGL 2 ไม่พร้อมหรือผู้เล่นเปิดโหมดลดการเคลื่อนไหว ระบบจะใช้ 2D อัตโนมัติ
- ในฉาก 3D สามารถคลิกต้นไม้เพื่อเดินไปเตรียมตัดได้โดยตรง มีป้ายแยกโซนตัดไม้และที่ดินของผู้เล่น พร้อมหัวใจหรือประกายลอยเหนือสัตว์เป็นระยะ
- จุดที่คลิกเดินและต้นไม้ที่เลือกจะแสดงวงแหวนตอบรับในฉาก 3D พร้อมการไหวเบา ๆ ของยอดไม้ การลอยของเมฆ และจังหวะน้ำพุ โดยหยุดการเคลื่อนไหวเหล่านี้เมื่อเปิดโหมดลดการเคลื่อนไหว
